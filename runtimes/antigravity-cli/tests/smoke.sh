...
run_runtime_smoke_cases() {
  ...
  assert_json_value "$sandbox_antigravity/home/.gemini/antigravity-cli/mcp_config.json" "data['mcpServers']['brave-search']['command'] == 'bunx'"
  assert_json_value "$sandbox_antigravity/home/.gemini/antigravity-cli/mcp_config.json" "data['mcpServers']['firecrawl']['command'] == 'bunx'"
