...
- Treat active-runtime temp scratch artifacts (for example, `/tmp/claude-code/b-agentic/...`, `/tmp/opencode/b-agentic/...`, or `/tmp/codex-cli/b-agentic/...`) as disposable scratch. Report their paths when they matter, but do not promise persistence.
