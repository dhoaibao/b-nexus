...
- **Sensitive artifacts:** auth/session state and similar secrets default to the active runtime's user-scope b-agentic directory or temp scratch path (for example, `~/.claude/b-agentic/<skill>/<run-id>/`, `~/.config/opencode/b-agentic/<skill>/<run-id>/`, `~/.codex/b-agentic/<skill>/<run-id>/`, `~/.gemini/b-agentic/<skill>/<run-id>/`, `/tmp/claude-code/b-agentic/<skill>/<run-id>/`, `/tmp/opencode/b-agentic/<skill>/<run-id>/`, `/tmp/codex-cli/b-agentic/<skill>/<run-id>/`, or `/tmp/gemini-cli/b-agentic/<skill>/<run-id>/`); never store them in a tracked worktree path.
- **Temporary logs:** the active runtime's temp scratch path (for example, `/tmp/claude-code/b-agentic/<skill>/<slug>.log`, `/tmp/opencode/b-agentic/<skill>/<slug>.log`, `/tmp/codex-cli/b-agentic/<skill>/<slug>.log`, or `/tmp/gemini-cli/b-agentic/<skill>/<slug>.log`).
...
- Treat active-runtime temp scratch artifacts (for example, `/tmp/claude-code/b-agentic/...`, `/tmp/opencode/b-agentic/...`, `/tmp/codex-cli/b-agentic/...`, or `/tmp/gemini-cli/b-agentic/...`) as disposable scratch. Report their paths when they matter, but do not promise persistence.
